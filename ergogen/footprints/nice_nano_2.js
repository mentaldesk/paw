...
module.exports = {
  ...
  body: p => {
    ...
    function pins(def_neg, def_pos) {
      return `
        ${''/* pin names */}
        (fp_text user B+ (at -16.51 ${def_pos}5.473715 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        ...
        (fp_text user B- (at -16.51 ${def_neg}5.53719 ${p.rot + 90}) (layer F.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15))))
        ...
        (fp_text user B+ (at -16.51 ${def_pos}5.473715 ${p.rot + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        ...
        (fp_text user B- (at -16.51 ${def_neg}5.53719 ${p.rot + 90}) (layer B.SilkS) (effects (font (size 0.8 0.8) (thickness 0.15)) (justify mirror)))
        ...
        (pad 1 thru_hole circle (at -16.51 ${def_neg}7.62) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) ${p.BMINUS.str})
